...
class Autor:
    ...
    def insert(self) -> int:
        return self.AutordDAO.insert(self.nombre, self.apellido1, self.apellido2)
    
    def delete(self) -> int:
        return self.AutordDAO.delete(self.nombre, self.apellido1, self.apellido2)
    
    def reset(self) -> int:
        return self.AutordDAO.reset()
    
    def SelectAutor(self) -> list:
        return self.AutordDAO.SelectAutor(self.nombre, self.apellido1, self.apellido2)
