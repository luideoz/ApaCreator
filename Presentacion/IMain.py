...
class IMain:
    def __init__(self):
        ...
        kitty1 = PhotoImage(file=self.config["kitty1-image"])
        kitty2 = PhotoImage(file=self.config["kitty2-image"])
        kitty3 = PhotoImage(file=self.config["kitty3-image"])
        kitty4 = PhotoImage(file=self.config["kitty4-image"])
        kitty5 = PhotoImage(file=self.config["kitty5-image"])
        ...
        self.btn_agregar_autor = Button(self.frame_autores, text="Agregar", font=(self.config["font-family"],  self.config["btn-font-size"]),command=self.agregar_autor, image=kitty1, compound="left", height=35)
        self.btn_agregar_autor.place(x=350, y=360)
        self.btn_eliminar_autor = Button(self.frame_autores, text="Eliminar", state="disabled",font=(self.config["font-family"], self.config["btn-font-size"]), height=35,command=self.eliminar_autor, image=kitty2, compound="left")
        self.btn_eliminar_autor.place(x=550, y=360)
        self.btn_reset_autor = Button(self.frame_autores, text="Reset", font=(self.config["font-family"], self.config["btn-font-size"]),command=self.reset_autores, image=kitty3, compound="left", height=35)
        self.btn_reset_autor.place(x=750, y=360)
        self.btn_back = Button(self.frame_autores, text="Volver", font=(self.config["font-family"], self.config["btn-font-size"]), state="disabled", command=self.back_tab_autores, image=kitty4, compound="left", height=35)
        self.btn_back.place(x=350, y=500)
        self.btn_next = Button(self.frame_autores, text="Siguiente", font=(self.config["font-family"], self.config["btn-font-size"]),state="disabled", command=self.next_tab_autores, image=kitty5, compound="left", height=35)
        ...
        self.btn_agregar_editorial = Button(self.frame_editorial, text="Agregar", font=(self.config["font-family"], self.config["btn-font-size"]), command=self.agregar_editorial, image=kitty1, compound="left", height=35)
        self.btn_agregar_editorial.place(x=350, y=360)
        self.btn_eliminar_editorial = Button(self.frame_editorial, text="Eliminar",state="disabled", font=(self.config["font-family"], self.config["btn-font-size"]),command=self.eliinar_editorial, image=kitty2, compound="left", height=35)
        self.btn_eliminar_editorial.place(x=550, y=360)
        self.btn_reset_editorial = Button(self.frame_editorial, text="Reset", font=(self.config["font-family"], self.config["btn-font-size"]), command=self.reset_editorial, image=kitty3, compound="left", height=35)
        self.btn_reset_editorial.place(x=750, y=360)
        self.btn_back_editorial = Button(self.frame_editorial, text="Volver", font=(self.config["font-family"], self.config["btn-font-size"]),  command=self.back_tab_autores, image=kitty4, compound="left", height=35)
        self.btn_back_editorial.place(x=350, y=500)
        self.btn_next_editorial = Button(self.frame_editorial, text="Siguiente", font=(self.config["font-family"],self.config["btn-font-size"]), state="disabled", command=self.next_tab_editoriak, image=kitty5, compound="left", height=35)
